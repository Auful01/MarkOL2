    ...
    <div class="row d-flex justify-content-around">
        <div class="col-md-12 mb-5">
            ...
            <div class="left-side mr-5" style="width: 150px; float: left;">
                ...
                <div class="d-flex justify-content-center">
                    <!--<button class="btn btn-primary edit-foto" data-target="#upfoto"  data-toggle="modal" data-url="{{route('upfoto',Request::segment(2))}}" @if ($profil != null)-->
                    <!--  data-foto="{{$profil->photo}}" -->
                   
                    <!--@endif-->
                    <!--style="margin-top: 10px;width: max-content">Edit Foto</button>-->
                    <input type="file" name="photo" class="btn btn-primary upload-foto" id="" hidden>
                </div>
            </div>
            <div class="right-side detail mt-1" style="margin-top:-20px">
                <h4 >{{$user->name}}</h4>
        ...
        <div class="col-md-6">
            ...
            <div class="row container">
                ...
                <button href="" class="btn btn-info mt-3 ml-auto" style="width: max-content" data-toggle="modal" data-target="#createPendidikan">Buat Pendidikan</button>
                @endif
        ...
        <div class="modal-body">
            <form action="" class="editModal url" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="nim" class="form-control nim" id="nim" aria-describedby="emailHelp" placeholder="Masukkan NIM">
                </div>
                <div class="form-group">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{route('profil-user.store')}}" method="POST">
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1">NIM</label>
                  <input type="text" name="nim" class="form-control" id="nim" aria-describedby="emailHelp" placeholder="Masukkan NIm">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Domisili</label>
        ...
        <div class="modal-body">
            <form action="" class="editModal url" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="instansi" class="form-control instansi" id="instansi" aria-describedby="emailHelp" placeholder="Masukkan Instansi">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Jenjang</label>
                  <input type="text" name="jenjang" class="form-control jenjang" id="jenjang" placeholder="Jenjang">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Fakultas</label>
                  <input type="text" name="fakultas" class="form-control fakultas" id="fakultas" placeholder="Fakultas">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Jurusan</label>
                  <input type="text" name="jurusan" class="form-control jurusan" id="jurusan" placeholder="Jurusan">
                </div>
                <div class="form-group">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action=" {{route('pendidikan-user.store')}}" method="POST">
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1">Instansi</label>
                  <input type="text" name="instansi" class="form-control" id="instansi" aria-describedby="emailHelp" placeholder="Masukkan Instansi">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Jenjang</label>

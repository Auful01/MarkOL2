            ...
            <td>
                <div class="d-flex">
                    ...
                    <form action="{{route('layananWeb.destroy',$k->id)}}" method="POST">
                        @csrf
                        @method('DELETE')
                        <button class="btn btn-danger"  onclick="return confirm('Apakah anda yakin ingin menghapus file ini?')"><i class="far fa-trash-alt"></i></button>
                    </form>
                </div>
            </td>
        </tr>
        ...
        <div class="modal-body">
            <form action="{{route('layananWeb.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <textarea name="konten" class="form-control konten" id="konten" cols="30" rows="10"></textarea>

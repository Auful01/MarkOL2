...
Route::get('/profil-id/{id}',[ProfilController::class,'showByIDProfil'])->name('profil-id');
Route::get('/produk-lv/{id}',[ProdukController::class,'showProdukLevel'])->name('produk-lv');
Route::get('/produk-id/{id}',[ProdukController::class,'showProdukID'])->name('produk-id');
Route::get('/layanan-id/{id}',[LayananController::class,'showLayananID'])->name('layanan-id');
Route::get('/agenda-id/{id}',[AgendaController::class,'showAgendaID'])->name('agenda-id');
Route::get('/kiriman-id/{id}',[KirimanController::class,'showID'])->name('kiriman-id');
